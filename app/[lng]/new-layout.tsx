...
export default function GardenGuruLanding() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      {/* Header */}
      <header className="px-4 lg:px-6 h-16 flex items-center border-b border-green-100">
        <div className="flex items-center space-x-2">
          <div className="w-8 h-8 bg-green-600 rounded-full flex items-center justify-center">
            <Leaf className="w-5 h-5 text-white" />
          </div>
          <span className="text-xl font-bold text-green-800">Garden-Guru</span>
        </div>
        <nav className="ml-auto hidden md:flex space-x-6">
          <a href="#how-it-works" className="text-green-700 hover:text-green-800 font-medium">
            How It Works
          </a>
          <a href="#features" className="text-green-700 hover:text-green-800 font-medium">
            Features
          </a>
          <a href="#testimonials" className="text-green-700 hover:text-green-800 font-medium">
            Reviews
          </a>
        </nav>
      </header>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <Badge className="bg-green-100 text-green-800 hover:bg-green-100">Your Personal Plant Whisperer</Badge>
            ...
            <div className="relative">
              ...
              <div className="absolute -right-4 top-8 bg-white rounded-lg shadow-lg p-4 max-w-xs">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="font-medium text-sm">Today's Task</span>
                </div>
                <p className="text-sm text-gray-600">Water your Monstera - soil feels dry!</p>
              </div>
              ...
              <div className="absolute -left-4 bottom-8 bg-white rounded-lg shadow-lg p-4 max-w-xs">
                ...
                <p className="text-sm text-gray-600">Move your Snake Plant closer to the window</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="px-4 py-16 bg-green-50">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-green-900 mb-8">Tired of Guesswork? We Were Too.</h2>

          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-red-600 mb-4">Before Garden-Guru</h3>
              <div className="space-y-4">
            ...
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-green-600 mb-4">After Garden-Guru</h3>
              <div className="space-y-4">
                <div className="flex items-center space-x-3 text-gray-600">
      ...
      <section id="how-it-works" className="px-4 py-16">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-green-900 mb-4">Your 3 Steps to a Greener Thumb</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center space-y-4">
              ...
              <h3 className="text-xl font-semibold text-green-900">Tell Us About Your Plants</h3>
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-xl font-semibold text-green-900">Share Your Location</h3>
              <p className="text-green-700">
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-xl font-semibold text-green-900">Receive Daily Tasks</h3>
              <p className="text-green-700">
      ...
      {/* Features Section */}
      <section id="features" className="px-4 py-16 bg-gradient-to-r from-green-50 to-blue-50">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <h3 className="text-2xl font-semibold text-green-900">Location-Based Intelligence</h3>
                <p className="text-green-700">
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-semibold text-green-900">Smart Task Suggestions</h3>
                <p className="text-green-700">
            ...
            <div className="space-y-4">
              <h4 className="text-lg font-semibold text-green-900 mb-4">Today's Personalized Tasks</h4>
                ...
                <CardContent className="p-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <h5 className="font-medium text-gray-900">Water Wednesday</h5>
                      <p className="text-sm text-gray-600 mt-1">
                        Time to give your Monstera a drink! Check the soil moisture first.
                      </p>
                      <Button variant="outline" size="sm" className="mt-2 text-green-600 border-green-600">
                        Mark as Done
                      </Button>
                    </div>
                  </div>
              ...
              <Card className="border-green-200">
                <CardContent className="p-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <h5 className="font-medium text-gray-900">Fertilizer Friday</h5>
                      <p className="text-sm text-gray-600 mt-1">
              ...
              <Card className="border-green-200">
                <CardContent className="p-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <h5 className="font-medium text-gray-900">Soil Saturday</h5>
                      <p className="text-sm text-gray-600 mt-1">
              ...
              <CardContent className="p-6">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Plant Parent for 6 months</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-green-200">
              <CardContent className="p-6">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">David Johnson</p>
            ...
            <Card className="border-green-200">
              <CardContent className="p-6">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">Emily Liu</p>
                    <p className="text-sm text-gray-500">Busy Plant Mom</p>
                  </div>
                </div>
              </CardContent>
            </Card>
      ...
      {/* Final CTA */}
      <section className="px-4 py-16 bg-gradient-to-r from-green-600 to-green-700">
        <div className="container mx-auto max-w-4xl text-center">
          <div className="space-y-8 text-white">
            ...
            <div className="flex justify-center items-center space-x-6 text-sm text-green-100">
              <div className="flex items-center space-x-1">
                <CheckCircle className="w-4 h-4" />
